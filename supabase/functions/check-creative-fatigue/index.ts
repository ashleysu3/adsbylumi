...
Deno.serve(async (req) => {
  ...
  // This is a scheduled cron job. Require either the service role key
  // (used by the scheduler) or an admin user JWT to invoke.
  ...
  if (token !== serviceRoleKey) {
    // Allow admin users to manually trigger
