...
Deno.serve(async (req) => {
  ...
  try {
    ...
    console.log(`Weekly reports complete: ${sentCount} sent, ${skippedCount} skipped, ${errorCount} errors`);
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 100%); padding: 30px; text-align: center;">
              <h1 style="color: #ffffff; margin: 0; font-size: 24px; font-weight: 600;">📊 Weekly Performance Report</h1>
          ...
          <tr>
            <td style="padding: 30px 30px 20px 30px;">
              ...
              <p style="margin: 10px 0 0 0; color: #718096; font-size: 14px;">Here's how your ${brandName} ads performed this week.</p>
            </td>
          </tr>
