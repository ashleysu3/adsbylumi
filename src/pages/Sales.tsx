      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="inline-block mb-6 px-4 py-2 bg-primary/10 rounded-full">
            <span className="text-sm font-medium text-primary">🎉 Your Ad Assistant</span>
          </div>
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            You're not doing anything wrong. Meta ads are just… a lot.
          </p>
        </div>
      </section>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-center">
            {[
              "Meta ad strategy", "Creative psychology", "Performance troubleshooting",
              "Offer mapping", "Funnel breakdown analysis", "Script writing",
              "Copy frameworks", "Meta best practices", "Seasonality predictions",
              "Hook libraries", "Niche messaging", "Audience builder logic",
              "B-roll direction", "High-performing creative systems", "API-backed campaign builds"
            ].map((item) => (
