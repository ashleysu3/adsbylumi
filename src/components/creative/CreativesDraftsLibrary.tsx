...
import type { CreativeDraft, CreativeType } from "@/lib/creatives";
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Every hook, concept, graphic, b-roll and copy LUMI generates lands here as a draft.
          Nothing goes live until you add it to a campaign yourself.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div className="flex gap-2">
            {(["unused", "used", "all"] as const).map((s) => (
              <button
                key={s}
                type="button"
              ...
              >
                {s === "all" ? "All" : s === "unused" ? "Unused" : "Used"}
              </button>
            ))}
          </div>
        ...
        <Card className="border-dashed">
          <CardContent className="py-12 text-center text-muted-foreground space-y-2">
            ...
            <p className="text-sm">
              ...
              to make something — every output saves here as a draft.
            </p>
          </CardContent>
        </Card>
      ) : (
...
function toolForType(t: string): string {
  if (t === "hook" || t === "primary_copy" || t === "headline" || t === "description" || t === "caption" || t === "cta") return "copy";
  ...
  return (
    <Card className="group">
      ...
      <CardContent className="p-4 space-y-2">
        ...
        {draft.title && <p className="text-sm font-medium line-clamp-2">{draft.title}</p>}
        {text && (
