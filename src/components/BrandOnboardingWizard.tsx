                 ...
                 return (
                   <button
                     ...
                     className={cn(
                       ...
                       index !== currentStep && step.isComplete && 'border-green-500 bg-green-500/10 text-green-600',
             ...
             <AnimatePresence mode="wait">
               ...
               >
                 <div className={cn(
                   ...
                   currentStepData.isComplete ? 'bg-green-500/10' : 'bg-muted/50'
                 )}>
                   <div className={cn(
                     'mx-auto w-16 h-16 rounded-full flex items-center justify-center',
                     currentStepData.isComplete ? 'bg-green-500/20' : 'bg-primary/10'
                   )}>
